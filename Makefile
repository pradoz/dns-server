...
TESTS = test_dns_trie test_dns_records test_dns_parser test_dns_resolver test_dns_server test_dns_zone_file test_dns_recursive test_dns_bugs test_dns_cache
